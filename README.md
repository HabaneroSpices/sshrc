...
This project is a near direct Golang translation of Russell Stewarts SSHRC originally written in shell/bash. 

A maintaned version of the orignal repo can be found here: [sshrc](https://github.com/cdown/sshrc)
...
* To enable fuzzy TUI tab completion in zsh, use the [sshrc-zsh-plugin](https://github.com/habanerospices/sshrc-zsh-plugin) plugin.
